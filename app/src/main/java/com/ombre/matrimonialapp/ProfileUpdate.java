...
public class ProfileUpdate extends AppCompatActivity {
    ...
    MaterialSpinner spinner,spinner2,spinner3,spinner4,spinner5,spinner6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(ProfileUpdate.this, "Complete Your Profile", Toast.LENGTH_SHORT).show();
                }
                else
   ...
   spinner2 = (MaterialSpinner)findViewById(R.id.salary);
        spinner3 = (MaterialSpinner)findViewById(R.id.weight);
    spinner4 = (MaterialSpinner)findViewById(R.id.height);
spinner5 = (MaterialSpinner)findViewById(R.id.color);
        spinner6= (MaterialSpinner)findViewById(R.id.religion);
        ...
        choose1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Get Current Time
                TimePickerDialog timePickerDialog=new TimePickerDialog(ProfileUpdate.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
...
getProfile();
        ...
        choose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(ProfileUpdate.this);
                // alertDialog.setTitle("ADD ROOM");
                //   alertDialog.setMessage(" PLZ ADD Room details");

                LayoutInflater inflater = LayoutInflater.from(ProfileUpdate.this);
    ...
    {
        final Context context=ProfileUpdate.this;
        final ProgressDialog progressDialog=new ProgressDialog(context);
        final SharedPreferences prefs =ProfileUpdate.this.getSharedPreferences("xy", Context.MODE_PRIVATE);
        ...
        StringRequest request=new StringRequest(Request.Method.POST, "https://pseudoblog.in/Matrimony/addprofile.php", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Intent intent=new Intent(ProfileUpdate.this,Welcome.class);
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data){
        ...
        if (requestCode == 1 && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            try {
                ...
                bitmap= MediaStore.Images.Media.getBitmap(ProfileUpdate.this.getContentResolver(),postimageuri);
...
//        Toast.makeText(getActivity(), "Enter", Toast.LENGTH_SHORT).show();
        ...
        SharedPreferences.Editor editor = ProfileUpdate.this.getSharedPreferences("xy", Context.MODE_PRIVATE).edit();
    ...
    public void  getProfile()
    {
        ...
        StringRequest request=new StringRequest(Request.Method.POST, "https://pseudoblog.in/Matrimony/getprofile.php", new Response.Listener<String>() {
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ProfileUpdate.this, ""+error.getMessage(), Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }
        }
        ...
        RequestQueue requestQueue= Volley.newRequestQueue(ProfileUpdate.this);
        requestQueue.add(request);
